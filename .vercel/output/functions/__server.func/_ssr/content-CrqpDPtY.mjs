//#region node_modules/.nitro/vite/services/ssr/assets/content-CrqpDPtY.js
var ba_1_before_default = "/assets/ba-1-before-D5fl2IrW.jpg";
var ba_1_after_default = "/assets/ba-1-after-B3rbuDYZ.jpg";
var ba_2_before_default = "/assets/ba-2-before-DZ6xnCAa.jpg";
var ba_2_after_default = "/assets/ba-2-after-C2r_cARq.jpg";
var ba_3_before_default = "/assets/ba-3-before-DxgX9mVp.jpg";
var ba_3_after_default = "/assets/ba-3-after-Xf5HIfu4.jpg";
var BRAND = {
	name: "PatchHouse",
	whatsappNumber: "919999999999",
	whatsappMessage: "Hi! I'm interested in a free at-home hair patch consultation. My name is ____ and I'm located in ____ (Delhi NCR). Please share the next available slot.",
	cities: [
		"Delhi",
		"Noida",
		"Greater Noida",
...
var waLink = (msg = BRAND.whatsappMessage) => `https://wa.me/${BRAND.whatsappNumber}?text=${encodeURIComponent(msg)}`;
var TRUST = [
...
var PROBLEMS = [
	{
		icon: "Camera",
		line: "Avoiding events and cameras"
	},
	{
		icon: "FlaskConical",
		line: "Trying oils and pills that never work"
	},
	{
		icon: "DoorClosed",
		line: "Too embarrassed to walk into a clinic"
	}
];
var BEFORE_AFTER = [
	{
	...
	},
	{
		...
		before: ba_3_before_default,
		after: ba_3_after_default
	}
];
var STEPS = [
	{
		...
		desc: "Share your details in 2 minutes."
	},
	{
		n: "02",
		title: "Expert visits your home",
		desc: "Private hair & scalp analysis."
	},
	{
		n: "03",
...
var EXPERTS = {
	...
	intro: "A small, handpicked team — not gig workers. Every PatchHouse expert is someone we would send to our own family.",
	points: [
		{
...
var TESTIMONIALS = [
	{
		...
		city: "Gurugram",
		rating: 5,
		quote: "No one in my building ever knew. I just looked better at my brother's wedding. The expert was completely professional."
	},
	{
		initials: "AS",
		name: "Arvind S.",
		...
		city: "Noida",
		rating: 4,
		quote: "Had been hiding under caps for three years. They came on a Sunday morning and I had my hairline back by lunch. Took me a few days to get used to the adhesive, but now I don't even think about it."
	},
	{
		initials: "MJ",
		name: "Manish J.",
		...
		city: "Delhi",
		rating: 5,
		quote: "What I valued most was the privacy. No clinic, no receptionist, no awkward stares. Just one calm conversation at home."
	},
	{
		initials: "DP",
		name: "Deepak P.",
		...
		city: "Faridabad",
		rating: 4,
		quote: "I almost cancelled twice out of nerves. So glad I didn't. The first colour match wasn't quite right, but they redid it on the spot. My wife noticed I was smiling in photos again."
	}
];
var FAQ = [
	{
...
//#endregion
export { FAQ as a, STEPS as c, waLink as d, EXPERTS as i, TESTIMONIALS as l, BRAND as n, PRICING as o, COMPARISON as r, PROBLEMS as s, BEFORE_AFTER as t, TRUST as u };
